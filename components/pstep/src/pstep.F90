...
contains
  ...
  subroutine initialisation_callback(current_state)
    ...
    l_tendp_3d_u   = current_state%u%active .or. l_tend_pr_tot_u
    l_tendp_3d_v   = current_state%v%active .or. l_tend_pr_tot_v
    l_tendp_3d_w   = current_state%w%active .or. l_tend_pr_tot_w
