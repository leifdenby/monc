...
contains
  ...
  subroutine timestep_callback(current_state)
    ...
    calculate_diagnostics = (current_state%time_basis .and. current_state%timestep == current_state%sample_timestep) &
         .or. (.not. current_state%time_basis .and. mod(current_state%timestep, diagnostic_generation_frequency) == 0)
