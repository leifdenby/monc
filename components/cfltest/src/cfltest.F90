...
contains
  ...
  subroutine timestep_callback(current_state)
    ...
    if (current_state%normal_step) then
      ...
      if (current_state%time_basis) call evaluate_time_basis(current_state) 
  ...
  subroutine evaluate_time_basis(current_state)
    ...
    projected_time = current_state%time + current_state%dtm + (current_state%dtm_new * ts_to_next_cfl) + dtmmin
