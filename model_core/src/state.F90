...
module state_mod
  ...
  type, public :: model_state_type
    ...
    logical :: reconfig_run=.false.    ! whether this is the first cycle of a reconfigured continuation run
    logical :: retain_model_time=.false.  ! by default, reconfigurations have model time reset to zero 
    logical :: normal_step=.true.      ! not doing special, shortened timestep due to proximity to a sample_timestep
    ...
    integer :: timestep=1, column_global_x, column_global_y, column_local_x, column_local_y, field_stepping, scalar_stepping, &
         ...
         cfl_frequency, termination_reason, sample_timestep_3d=0, sample_timestep=0, next_3d_sample_time=0, next_sample_time=0
    ...
    logical :: first_timestep_column, last_timestep_column, halo_column, first_nonhalo_timestep_column, &
         ...
         io_server_enabled, time_basis=.false.
